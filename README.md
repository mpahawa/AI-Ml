...
### Installation:
Open the note book and google colab and mount your drive with dataset 

### Dataset:
Open the terminal go download https://drive.google.com/uc?id=1ehyrYBQ5rbQQe6yL4XbLWe3FMvuVUGiL
